...
- **Agent Guidelines**: `~/workspace/AGENTS.md`
- **Safety Protocols**: `~/workspace/CascadeProjects/Projects/GRID-main/.claude/rules/safety.md`
- **OS Guardrails**: `/mnt/arch_data/home/caraxes/skills/os-guardrails/SKILL.md` (archived)

### Git Configuration
- **Main Monorepo**: `~/workspace/CascadeProjects/` (MCP servers, shared types)
- **GRID Submodule**: `~/workspace/CascadeProjects/Projects/GRID-main/` → `roots/GRID/`
...
export GRID_VENV=~/workspace/CascadeProjects/Projects/GRID-main/.venv/bin/python  # rebuild venv on Ubuntu
```
