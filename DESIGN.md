...
This file is **fold 2** of the [fourfold neighborhood](docs/FOURFOLD_NEIGHBORHOOD.md): **cartography** — what exists, how it borders other systems, and where change belongs.
...
**Floor snap:** root fourfold closure (~92%+) — [`docs/FOUR_ON_THE_FLOOR.md`](docs/FOUR_ON_THE_FLOOR.md); verify with `make fourfold-snap`.
